...
class Pdf {
	 ...
	 *
	 * @param array $permisson Permissions e.g.: ['copy', 'print']
	...
	public function setProtection($permisson, $userPassword = '', $ownerPassword = '')
	{
		...
		// Call the SetProtection method without returning its value
	...
	public function save($filename)
	{
		...
		return $this; // Return the instance of the Pdf class
	}
	...
	{
		$pdfContent = $this->mpdf->Output('', 'S'); // Get the PDF content as a string
